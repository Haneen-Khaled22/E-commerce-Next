'use client';
import { login, loginFacebook } from '@/util/actions';
import Image from 'next/image';
import React from 'react';

interface Props {}

function SignInWithFacebookButton(props: Props) {
  return (
    <form action={loginFacebook} className="w-full flex justify-center">
      <button
